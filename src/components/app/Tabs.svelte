...
<div class="rounded-xl max-w-lg flex justify-center my-4 mx-auto bg-light p-2 sm:p-6">
    <!-- <nav aria-label="Navigation panel" class="flex">
    <ol class="inline-flex items-center space-x-1 md:space-x-3">
      ...
      <li class="inline-flex items-center">
        ...
        <a href="/" class="ml-1 text-sm font-medium text-gray-700 hover:text-gray-900 md:ml-2 dark:text-gray-400 dark:hover:text-white">Projects
        </a>
      </li> 
    </ol>
  </nav> -->
