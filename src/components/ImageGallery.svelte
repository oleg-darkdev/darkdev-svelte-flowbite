			...
			<div class="flex flex-row flex-wrap">
				<div class="wi fb to/3 p-1">
					<div class="c i pg sg z-1">
						<img src="/organisator/sparing_4.JPG" alt="Project" />
					</div>
				</div>

				<div class="wi fb p-1 to/3 ">
					<div class="c i pg sg z-1">
						<img src="/organisator/sparing_2.JPG" alt="Project" />
					</div>
				</div>
			</div>

			<div class="wi fb vo/3 -mb-8 -mt-8">
				<div class="c i pg sg z-1">
					<img src="/organisator/sparing_1.JPG" alt="Project" />
				</div>
			</div>
			<div class="wi fb vo/3 -mb-8 -mt-8 ">
				<div class="c i pg sg z-1">
